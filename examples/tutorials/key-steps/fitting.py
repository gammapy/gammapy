...
:doc:`/tutorials/key-steps/priors` tutorial.

One can also perform a Bayesian analysis using a nested sampling technique. This is described
in the :doc:`/tutorials/key-steps/nested_sampling_Crab` tutorial.
...
how datasets and models interact, see the :doc:`/tutorials/key-steps/model_management` tutorial.
...
See also: :doc:`/tutorials/key-steps/models` and :ref:`modeling`.
