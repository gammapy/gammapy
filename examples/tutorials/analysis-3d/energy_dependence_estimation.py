...
Prerequisites
-------------
Knowledge on data reduction and datasets used in Gammpy, for example see ..........
...
estimator = EnergyDependenceEstimator(energy_edges=energy_edges, model=model)
...
######################################################################
# Plotting the results -- need implementation of SpatialModel extension error
# ---------------------------------------------------------------------------
