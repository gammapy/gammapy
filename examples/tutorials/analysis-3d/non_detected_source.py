...
# We also fix the spatial parameters of the model to avoid going to different regions.
#
...
######################################################################
# Note that this can be different from correlated upper limits computed with the `ExcessMapEstimator`
