...
>>>>>>> d251f2546 (adding requested changes to tutorial)
# 
...
bkg_maker = ReflectedRegionsBackgroundMaker(exclusion_mask=exclusion_mask,region_finder=region_finder)
...
safe_mask_maker = SafeMaskMaker(methods=["offset-max","aeff-max"], aeff_percent=10,offset_max=1.75*u.deg)
