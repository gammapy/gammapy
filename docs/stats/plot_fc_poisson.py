...
acceptance_intervals = fc_construct_acceptance_intervals_pdfs(matrix, fCL)

UpperLimitNum, LowerLimitNum, _ = fc_get_upper_and_lower_limit(MuBins, XBins, acceptance_intervals)
