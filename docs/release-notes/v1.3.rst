...
This release is based on numpy 1.2 and css for sphinx v15 (REPHRASE)
...
Fetures deprecated since Gammapy v1.2 have been removed. 
...
- A new tutorial showing how to perform energy dependent spectroscopy has been added

*gammapy.stats*

- Implementation of the Timmer-Koenig algorithm with leakage protection to simulate a time series from a power spectrum.
- Compution of the discrete structure function for a variable source using Emmanoulopoulos et al. (2010) algorithm.
