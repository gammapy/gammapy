...
This is a new Long Term Stable (LTS) release. Gammapy 2.0 will be maintained for the next two years, and we remove support for Gammapy 1.x versions. With Gammapy 2.0, we provide analysis support for major Imaging Atmospheric Cherenkov Telescope including H.E.S.S.,
