...
This is a new Long term stable release. Gammapy 2.0 will be maintained for the next two years, and we remove support for Gammapy 1.x versions. With Gammapy 2.0, we provide analysis support for major Imaging Atmospheric Cherenkov Telescope including H.E.S.S.,
VERITAS, MAGIC, LST1, Water Cherenkov Telesope like HAWC and SWGO, and Fermi-LAT.
...
- Four new tutorials have been added:
   ...
   - one explaining VERITAS analysis along with addition of VERITAS data in `$GAMMAPY_DATA` (:doc:`/tutorials/data/veritas`)
   - one explaining computation of upper limits for non-detected sources (:doc:`/tutorials/analysis-3d/non_detected_source`)
...
- Preserve parameters links in `Models.copy()`
