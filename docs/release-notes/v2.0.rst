...
This is a new Long term stable release. Gammapy 2.0 will be maintained for the next two years, and we removes support for
...
- [#5756] 3PC pulse profile (Maxime Regeard)
...
- [#5667] Refactor `min` and `max` setter on `Parameter` and `set_lim` method (Maxime Regeard)
