...
the `README.rst <https://github.com/gammapy/gammapy/blob/main/README.rst>`_ file, each contributor shall accept the
`DCO <https://github.com/gammapy/gammapy/blob/main/CONTRIBUTING.md#gammapy-developer-certification-of-origin>`_:
