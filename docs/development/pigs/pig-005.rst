...
estimation with 3D analysis (Regis and Atreyee).
...
multiple datasets. Enable joint Fermi-LAT / IACT analyses (Regis and Axel).
...
contours. Improve interactive handling of the fitting front end (Axel).
