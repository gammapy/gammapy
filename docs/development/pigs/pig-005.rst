...
* Gammapy 0.12 in May 2019
* Gammapy 0.13 in July 2019
...
simplify creation of custom index files. Implement support for event types.
...
methods such as ring- and adaptive ring-background. Implement spectral points
