...
* Current definitions defined by CTA (private link to slides_)
* Further requirements defined at the SUSS workshop Dec. 2018 (private link to indico_)
...
on Python, Numpy and Astropy to the community.

There will be a HESS validation paper. We will support
