...
The user want to find flares in the long term light curve of a variable source.
...
- Improve the user interface to ``Map``
- Clean-up serialization code, e.g. for ``MapAxis``

Possible major changes
~~~~~~~~~~~~~~~~~~~~~~

We discuss here some aspects that should be explored. The evaluation of the feasibility
will require some detailed prototyping. Such a major change would probably be possible
only when releasing v2.0.
