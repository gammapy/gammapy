...
response functions, the number of predicted counts is returned by the ``.evaluate()``
...
For spectral models Gammapy has defined default parameters, which simplifies the
