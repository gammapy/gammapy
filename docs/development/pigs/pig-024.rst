...
It is asked to cite the DOI of the used Gammapy version as well as the associated paper (e.g. about the latest LTS
release).
...
Any contribution without threshold on these topics renders a user as official Gammapy contributor. And the contributions
...
DCO is not accepted by a contributor, her/his contribution might not be usable and thus this user will not be in the
list of authors per default.
