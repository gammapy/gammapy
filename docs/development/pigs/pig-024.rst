...
`Developer Certificate of Origin` (DCO, see the text in `here <https://developercertificate.org/>`_) for each commit.
Its acceptation by contributors will permit to:
