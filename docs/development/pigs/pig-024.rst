...
Any contribution without threshold on these topics renders a user as official Gammapy contributor. Many of these contributions
are tracked using GitHub. However, the use of personal data is regulated in Europe and one should have the
...
Pull Request. Its acceptation by contributors will permit to:
...
.. important::
    ...
    synchronise their git email addresses with their GitHub addresses, to have a unique `ORCID <https://orcid.org/>`_
...
HAL/SW). This section is about feature releases. Bug releases will have as list of authors the one of its associated
...
accepted the GitHub DCO. If the DCO is not accepted by a contributor, her/his contribution might not be usable and thus
...
Conference contributions (Proceedings, Posters, ...) should be developed in dedicated repositories in the Gammapy Github
organization.
...
project. These requests to the Astropy community and CTAO for recommendations and preferences either remained
