...
It is asked to cite the DOI of the latest Gammapy paper as well as the paper associated to the latest LST release.
...
This scheme with these two references will be given on our web pages.
...
can be tracked using GitHub. However, the use of personal data is regulated in Europe and one should have the
...
The list of authors is composed of the union of all the contributors of the releases realised since the last LST
...
For the first LST release, the `V1.0`, all contributors from the beginning of the project will be co-authors per default.
...
1. List of authors
    ...
    - the list of contributors of the associated LST ordered by alphabetical order, as '(Gammapy Contributors)'
...
For any release, both metadata files should be carefully updated and systematically a review should be done by the dev
team.
