...
* Author: Christoph Deil, Régis Terrier, Axel Donath, David Fidalgo
* Created: July 2, 2018
* Accepted:
* Status: draft
...
computed in Gammapy. In general we propose to perform a spectral analysis in
each of the time bins of the light curve to obtain the integral flux. For this
purpose the new :class:`LightCurveEstimator` class should essentially be a
...
`~gammapy.data.GTI` table, which the background/spectrum classes would respect.
