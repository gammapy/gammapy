...
::
    ...
    return EventList[source1, source2, ...sourceN]
...
core of the sampling process. The `sample` is based on the `~gammapy.utils.random.InverseCDFSampler` 
...
the IRF corrections will not be applied.
