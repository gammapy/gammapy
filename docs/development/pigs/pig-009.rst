...
and treated separately in a 1D analysis, assuming that the temporal depence of the 
input source models factorizes.
...
Starting from a predicted number of counts map, obtained through dedicated Gammapy
