...
or `mamba <https://mamba.readthedocs.io/en/latest/installation/mamba-installation.html>`__**.
For certain working environments (e.g. ESO, DESY, CEA, MPIK), one should use
