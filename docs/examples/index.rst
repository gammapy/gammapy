...
The ``gammapy/examples`` folder contains small Python scripts
...
Below find two examples that listed by hand here:

fermi_diffuse.py
----------------

.. literalinclude:: ../../examples/fermi_diffuse.py
    :language: python

fermi_psf.py
------------

.. literalinclude:: ../../examples/fermi_psf.py
    :language: python
