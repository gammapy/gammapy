...
.. code-block:: bash
    ...
    curl -O https://gammapy.org/download/install/gammapy-0.18-environment.yml
    conda env create -f gammapy-0.18-environment.yml
...
This creates a conda environment called ``gammapy-0.18`` which you can activate via:

.. code-block:: bash

    conda activate gammapy-0.18
...
.. code-block:: bash
    ...
    gammapy download tutorials --release 0.18
