...
.. literalinclude:: ./spectrum_analysis_example.yaml
    :language: yaml
    :linenos:
...
* The `~gammapy.spectrum.SpectrumFit` class calls Sherpa in order to fit a
  model to the data
...
* Line 12    : Instantiate `~gammapy.spectrum.SpectrumFit`
