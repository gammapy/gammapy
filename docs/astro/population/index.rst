...
The `gammapy.astro.population` module provides a simple framework for population synthesis of gamma-ray sources, which is useful in the context of surveys and
population studies.
...
illsutrated in the following plot.
