...
class SourceCatalogObject4FGL(SourceCatalogObjectFermiBase):
    ...
    _energy_range = u.Quantity([50, 100, 300, 1000, 3000, 10000, 30000, 300000], "MeV")
    ...
    def flux_points(self):
        ...
        table["e_min"] = self._energy_range[:-1]
        table["e_max"] = self._energy_range[1:]
...
class SourceCatalogObject3FGL(SourceCatalogObjectFermiBase):
    ...
    _energy_range = u.Quantity([100, 300, 1000, 3000, 10000, 100000], "MeV")
    _energy_range_suffix = ["100_300", "300_1000", "1000_3000", "3000_10000", "10000_100000"]
    ...
    def flux_points(self):
        ...
        # Square root of test statistic
        table["sqrt_TS"] = [self.data["Sqrt_TS" + _] for _ in self._energy_range_suffix]
        return FluxPoints(table)

    def _get_flux_values(self, prefix, unit="cm-2 s-1"):
        values = [self.data[prefix + _] for _ in self._energy_range_suffix]
        return u.Quantity(values, unit)
...
class SourceCatalogObject2FHL(SourceCatalogObjectFermiBase):
    ...
    _energy_range = u.Quantity([50, 171, 585, 2000], "GeV")
    _energy_range_suffix = ["50_171", "171_585", "585_2000"]
    ...
    def _get_flux_values(self, prefix, unit="cm-2 s-1"):
        values = [self.data[prefix + _ + "GeV"] for _ in self._energy_range_suffix]
        return u.Quantity(values, unit)
...
class SourceCatalogObject3FHL(SourceCatalogObjectFermiBase):
    ...
    _energy_range = u.Quantity([10, 20, 50, 150, 500, 2000], "GeV")
