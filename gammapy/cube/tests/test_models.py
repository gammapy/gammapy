...
def edisp(geom, geom_true):
    e_reco = geom.get_axis_by_name("energy").edges * geom.get_axis_by_name("energy").unit
    e_true = geom_true.get_axis_by_name("energy").edges * geom_true.get_axis_by_name("energy").unit
