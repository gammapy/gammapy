...
class TestSkyModelMapEvaluator:
    ...
    def test_compute_flux(evaluator):
        ...
        assert_allclose(out[0, 0, 0], 4.626744e-14, rtol=1e-5)
    ...
    def test_apply_psf(evaluator):
        ...
        assert_allclose(out.data[0, 0, 0], 2.405335e-08, rtol=1e-5)
    ...
    def test_apply_edisp(evaluator):
        ...
        assert_allclose(out.data[0, 0, 0], 4.626744e-08, rtol=1e-5)
