...
class ImageAnalysis(object):
    ...
    center : ``astropy.coordinates import SkyCoord`
        Center of the image
    ...
    def __init__(self, center, energy_band, data_store):
    ...
    def make_background(self, obs_id):
        ...
        bkg_hdu = fill_acceptance_image(self.header, center, table["offset"], table["Acceptance"])
