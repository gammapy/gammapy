...
class spectral_data():
    """ Class to encapsulate spectral data and background to be used with wstat
        ...
        Author:      terrier@apc.univ-paris7.fr
    """
    def __init__(self,data,bkg):
        ...
        #print self.OFFalpha, self.ONalpha, self.alpha
...
def wfit(dataids=None):
    ...
    set_stat(mystat)
    set_method("neldermead") # set_method("moncar")
    set_conf_opt("max_rstat",1000) # We don't use a specific maximum reduced statistic value
