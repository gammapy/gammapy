...
class MapEvaluator:
    ...
    def __init__(
        ...
        if isinstance(self.model, TemplateDataModel) or self.model.spatial_model is None or self.model.evaluation_radius is None:
    ...
    def needs_update(self):
        ...
        if isinstance(self.model, TemplateDataModel):
            return False
    ...
    def apply_psf_after_edisp(self):
        """"""
        if not isinstance(self.model, TemplateDataModel):
