...
def standard_scaler(features):
    ...
    ------------------- ------ --------------------
    -0.1379190199411072  20136 -0.18046952655570045
     1.2878662980203586  20137   1.3049664466089965
    -1.1499472780792264  20151  -1.1244969200533408
    """
...
def hierarchical_clustering(features, linkage_kwargs=None, fcluster_kwargs=None):
    ...
    ------------------- ------ ------------------- ------
    -1.3020791585780918  20326 -1.2471938975366008      2
    -1.3319831545296006  20327 -1.4586649826004114      2
    -0.776330721981745  20339 -0.6705024680435898      2
     0.9677107409821933  20343  0.9500979841335693      1
     0.8205629520229849  20344  0.8160964882165554      1
     0.7771617763706838  20345  0.7718272408581743      1
     0.8449575657135842  20346  0.8383396349722769      1
