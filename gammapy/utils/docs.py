    ...
    def run(self):
        ...
        <div class="card tutorial-card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center" data-bs-toggle="collapse" data-bs-target="#{self.options["id"]}" style="cursor: pointer;">
                    <button class="btn btn-dark btn-sm me-2" style="background-color: #150458; border-radius: 50%; width: 24px; height: 24px;">
