...
def test_model_plot_sed_type():
    ...
    with mpl_plot_check():
        ...
        assert ax1.yaxis.units.is_equivalent(u.Unit("1 / (s cm2 TeV)"))
        assert ax1.axes.axes.get_ylabel().split()[0] == "dnde"
        assert ax2.yaxis.units.is_equivalent(u.Unit("1 / (s cm2 TeV)"))
    ...
    with mpl_plot_check():
        ...
        assert ax1.yaxis.units.is_equivalent(u.Unit("1 / (s cm2)"))
        assert ax1.axes.axes.get_ylabel().split()[0] == "flux"
        assert ax2.yaxis.units.is_equivalent(u.Unit("1 / (s cm2)"))
