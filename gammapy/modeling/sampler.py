...
class Sampler:
    ...
    Examples
    --------
    For a usage example, see :doc:`/tutorials/key-steps/nested_sampling_Crab` tutorial.
...
class SamplerResult:
    ...
    sampler_results : dict
        Output of sampler.
        See the :doc:`/tutorials/key-steps/nested_sampling_Crab` tutorial for a complete description.
    """
