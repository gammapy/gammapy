...
- [#559] Add paste, cutout and look_up methods to SkyImage class (Axel Donath)
...
- [#544] Improve SkyImage.coordinates (Olga Vorokh)
...
- [#518] Fixes and cleanup for SkyImage (Axel Donath)
...
- [#487] Add SkyImage class (Axel Donath)
